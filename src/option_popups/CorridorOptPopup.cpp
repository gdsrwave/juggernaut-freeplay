...
bool CorridorOptPopup::setup(std::string const& value) {
        ...
        bool usingSetSeed = Mod::get()->getSavedValue<bool>("opt-0-using-set-seed");
        ...
        std::string seedLoad = numToString(Mod::get()->getSavedValue<uint32_t>("opt-0-seed"));
        ...
        std::string lengthLoad = numToString(Mod::get()->getSavedValue<int32_t>("opt-0-length"));
        ...
        std::string chLoad = numToString(Mod::get()->getSavedValue<int16_t>("opt-0-corridor-height"));
