...
void SpeedSizeOptPopup::save(CCObject*) {
    ...
    mod->setSavedValue<int8_t>("opt-0-starting-speed", m_sspeedIndex);
    mod->setSavedValue<int8_t>("opt-0-speed-changes", m_speedChangesData);
    ...
    mod->setSavedValue<int8_t>("opt-0-starting-size", m_ssizeIndex);
    mod->setSavedValue<int8_t>("opt-0-size-transition-type", m_tTypeIndex);
