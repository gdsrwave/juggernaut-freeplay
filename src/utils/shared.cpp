...
// Enum to string maps
const std::map<int, std::string> SpeedChangeLabel = {
    {0, "None"},
    {1, "Speed1x"},
    {2, "Speed2x"},
    {3, "Speed3x"},
...
const std::map<int, std::string> VisibilityLabel = {
    {0, "Standard"},
    {1, "Low"},
    {2, "Hidden"}
};
...
const std::map<int, std::string> PortalInputsLabel = {
    {0, "Both"},
    {1, "Releases"},
    {2, "Holds"}
};

const std::map<int, std::string> PlacementBySizeLabel = {
    {0, "Both"},
    {1, "Big"},
    {2, "Mini"}
};

const std::map<int, std::string> StartingSizeLabel = {
    {0, "Big"},
    {1, "Mini"},
    {2, "Random"}
};

const std::map<int, std::string> JFPBiomeLabel = {
    {0, "Juggernaut"},
    {1, "DeathFactory"},
    {2, "SawField"},
    {3, "SpikeRain"},
...
const std::map<int, std::string> MusicSourceLabel = {
    {0, "JFP Soundtrack"},
    {1, "Local Music"}
};

const std::map<int, std::string> SizeTransitionsLabel = {
    {0, "Type A"},
    {1, "Type B"}
};
